...
#' @family internal
#'
#' @importFrom cli cli_abort cli_text cli_warn
...
#'   safely walk2
#' @importFrom rlang !! := as_label as_name enexpr expr is_logical is_named list2
#'   set_names sym
#' @importFrom stringr str_c str_count str_detect str_extract str_remove
